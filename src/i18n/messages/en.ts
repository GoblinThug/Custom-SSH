...
export const en: Record<MessageKey, string> = {
  ...
  sqlBrowseTables: 'Tables',
  sqlBrowseViews: 'Views',
  sqlBrowseEmpty: 'Table is empty',
  sqlBrowseNoTables: 'No tables in this database',
  sqlBrowseLoadFailed: 'Failed to open database',
  sqlBrowseTooLarge: 'Database file is larger than 80 MB',
  sqlBrowseCorrupt: 'File is corrupt or not a SQLite database',
  sqlBrowseDumpInvalid: 'Failed to execute SQL dump',
  sqlBrowseSave: 'Save',
  sqlBrowseSaving: 'Saving…',
  sqlBrowseSaved: 'Saved to server',
  sqlBrowseSaveFailed: 'Failed to save',
  sqlBrowseAddRow: 'Add row',
  sqlBrowseDeleteRows: 'Delete',
  sqlBrowseRefresh: 'Refresh',
  sqlBrowsePrevPage: 'Previous',
  sqlBrowseNextPage: 'Next',
  sqlBrowsePage: 'Page {page} / {pages}',
  sqlBrowseRows: '{count} rows',
  sqlBrowseViewReadonly: 'Views are read-only',
  sqlBrowseDirty: 'Unsaved changes',
  sqlBrowseUnsavedTitle: 'Unsaved changes',
  sqlBrowseUnsavedMessage: 'The database has unsaved changes.',
  sqlBrowseUnsavedDetail: 'Save before closing, or discard your edits.',
  sqlBrowseSaveAndClose: 'Save and close',
  sqlBrowseDiscard: 'Discard',
