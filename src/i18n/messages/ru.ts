...
export const ru: Record<MessageKey, string> = {
  ...
  fileOpenSqlBrowse: 'SQL Browse',
  fileEditAsText: 'Открыть как текст',
  ...
  archiveRoot: 'Архив',
  sqlBrowseTitle: 'SQL Browse',
  sqlBrowseTables: 'Таблицы',
  sqlBrowseViews: 'Представления',
  sqlBrowseEmpty: 'Таблица пуста',
  sqlBrowseNoTables: 'В базе нет таблиц',
  sqlBrowseLoadFailed: 'Не удалось открыть базу данных',
  sqlBrowseTooLarge: 'Файл БД больше 80 МБ',
  sqlBrowseCorrupt: 'Файл повреждён или это не SQLite',
  sqlBrowseDumpInvalid: 'Не удалось выполнить SQL-дамп',
  sqlBrowseSave: 'Сохранить',
  sqlBrowseSaving: 'Сохранение…',
  sqlBrowseSaved: 'Сохранено на сервер',
  sqlBrowseSaveFailed: 'Не удалось сохранить',
  sqlBrowseAddRow: 'Добавить строку',
  sqlBrowseDeleteRows: 'Удалить',
  sqlBrowseRefresh: 'Обновить',
  sqlBrowsePrevPage: 'Назад',
  sqlBrowseNextPage: 'Вперёд',
  sqlBrowsePage: 'Стр. {page} / {pages}',
  sqlBrowseRows: 'Строк: {count}',
  sqlBrowseViewReadonly: 'Представление только для чтения',
  sqlBrowseDirty: 'Есть несохранённые изменения',
  sqlBrowseUnsavedTitle: 'Несохранённые изменения',
  sqlBrowseUnsavedMessage: 'В базе есть несохранённые изменения.',
  sqlBrowseUnsavedDetail: 'Сохранить перед закрытием или отменить правки.',
  sqlBrowseSaveAndClose: 'Сохранить и закрыть',
  sqlBrowseDiscard: 'Не сохранять',
